...
// Inside patient_registration_screen.dart
import 'excel_utils.dart'; // Import your utility file
              ...
              onPressed: () {
                if (_selectedOrganization != null) {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text('Patient registered and data exported to Excel!')),
                  );
                }
              },
